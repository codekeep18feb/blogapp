  ...
  return (
    ...
    >
      <form>
        ...
        {openUpdateContent && <ModalWrapper isOpen={openUpdateContent} close={setopenUpdateContent}>
          Update fORM
        </ModalWrapper>}
        </div>
    ...
    {/* <div>
      <div>{JSON.stringify(openUpdate)}</div>
    {updateModalData && <ModalWrapper isOpen={openUpdate} 
    ...
    close={(data)=>{
      ...
      setUpdateModalData(false)
          ...
          <UpdateContentForm 
            updateContent={(e)=>updateContent(e,updateModalData.id)} 
